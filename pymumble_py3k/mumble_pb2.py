...
class Version(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _VERSION
  
  # @@protoc_insertion_point(class_scope:MumbleProto.Version)

class UDPTunnel(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _UDPTUNNEL
  
  # @@protoc_insertion_point(class_scope:MumbleProto.UDPTunnel)

class Authenticate(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
...
class Reject(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _REJECT
  
  # @@protoc_insertion_point(class_scope:MumbleProto.Reject)

class ServerConfig(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _SERVERCONFIG
  
  # @@protoc_insertion_point(class_scope:MumbleProto.ServerConfig)

class ServerSync(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _SERVERSYNC
  
  # @@protoc_insertion_point(class_scope:MumbleProto.ServerSync)

class ChannelRemove(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _CHANNELREMOVE
  
  # @@protoc_insertion_point(class_scope:MumbleProto.ChannelRemove)

class ChannelState(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _CHANNELSTATE
  
  # @@protoc_insertion_point(class_scope:MumbleProto.ChannelState)

class UserRemove(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _USERREMOVE
  
  # @@protoc_insertion_point(class_scope:MumbleProto.UserRemove)

class UserState(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _USERSTATE
  
  # @@protoc_insertion_point(class_scope:MumbleProto.UserState)

class BanList(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  class BanEntry(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
...
class TextMessage(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _TEXTMESSAGE
  
  # @@protoc_insertion_point(class_scope:MumbleProto.TextMessage)

class PermissionDenied(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _PERMISSIONDENIED
  
  # @@protoc_insertion_point(class_scope:MumbleProto.PermissionDenied)

class ACL(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  class ChanGroup(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
    DESCRIPTOR = _ACL_CHANGROUP
    
    # @@protoc_insertion_point(class_scope:MumbleProto.ACL.ChanGroup)
  
  class ChanACL(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
...
class QueryUsers(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _QUERYUSERS
  
  # @@protoc_insertion_point(class_scope:MumbleProto.QueryUsers)

class CryptSetup(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _CRYPTSETUP
  
  # @@protoc_insertion_point(class_scope:MumbleProto.CryptSetup)

class ContextActionModify(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _CONTEXTACTIONMODIFY
  
  # @@protoc_insertion_point(class_scope:MumbleProto.ContextActionModify)

class ContextAction(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _CONTEXTACTION
  
  # @@protoc_insertion_point(class_scope:MumbleProto.ContextAction)

class UserList(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  class User(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
...
class VoiceTarget(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  class Target(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
...
class PermissionQuery(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _PERMISSIONQUERY
  
  # @@protoc_insertion_point(class_scope:MumbleProto.PermissionQuery)

class CodecVersion(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _CODECVERSION
  
  # @@protoc_insertion_point(class_scope:MumbleProto.CodecVersion)

class UserStats(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  class Stats(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
...
class SuggestConfig(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
  DESCRIPTOR = _SUGGESTCONFIG
  
  # @@protoc_insertion_point(class_scope:MumbleProto.SuggestConfig)

class RequestBlob(message.Message, metaclass=reflection.GeneratedProtocolMessageType):
